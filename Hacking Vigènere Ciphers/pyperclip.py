# Modul pyperclip adalah sebuah pustaka lintas platform di Python yang memungkinkan Anda untuk menyalin dan menempel teks ke dan dari clipboard sistem operasi. Fungsi ini sangat berguna dalam berbagai skenario pemrograman, terutama ketika Anda perlu berinteraksi dengan clipboard untuk memudahkan proses copy-paste teks tanpa harus melakukannya secara manual.

# Cara Penggunaan
# Untuk menyalin teks ke clipboard, Anda menggunakan fungsi pyperclip.copy('teks yang ingin disalin').
# Untuk menempel (paste) teks dari clipboard, Anda menggunakan fungsi pyperclip.paste(), yang akan mengembalikan teks yang saat ini ada di clipboard sebagai string.
